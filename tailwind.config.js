...
/** @type {import('tailwindcss').Config} */
module.exports = {
  // 1) Tell Tailwind where to scan for classnames
  content: [
    "./src/**/*.{html,ts}"
  ],

  // 2) (Optional) Globally safelist any classes
  //    so they never get purged—even if Tailwind never sees them in your templates.
  safelist: [
    'fixed', 'top-5', 'right-5', 'w-full', 'max-w-sm',
    'bg-white', 'bg-green-500', 'bg-red-500',
    'rounded-lg', 'shadow-md', 'text-white', 'text-green-500', 'text-red-500',
  ...
  theme: {
    extend: {
      screens: {
        // custom “tablet” from 700px up to 1025px
        tablet: { min: '700px', max: '1025px' },
      },
      fontFamily: {
